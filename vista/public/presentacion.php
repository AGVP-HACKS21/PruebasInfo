    ...
    <section class="container-fluid bg-light mt-5 p-4 rounded fade-in">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <span class="navbar-text">
                        <a href="presentacion.php?rol_sesion=<?php echo $rol_sesion;?>" class="navbar-brand">
                            <img src="../asets/img/galeria/.jpeg" alt="" width="40" height="40" class="img-fluid align-content-md-around">
        ...
        <main class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                <center>
                    <figure class="figure">
                        <img src="../asets/img/galeria/.jpeg" alt="..." class="figure-img img-fluid rounded img-thumbnail">
