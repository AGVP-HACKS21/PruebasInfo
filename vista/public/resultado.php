...
<head>
    ...
    <link rel="stylesheet" href="../dataTableV/jsTables/vanilla-dataTables.min.css">
    <script src="../dataTableV/jsTables/vanilla-dataTables.min.js"></script>
</head>
<body>
    <section class="container bg-light mt-5 p-4 rounded fade-in">
        <main class="row my-4">
            <div class="col-lg-12">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 float-left my-5" data-aos="fade-up">
                 <a href="../public/pdf.php" class="btn btn-danger mb-3">REPORTE PDF</a> 
                 <a href="../public/reporte/excel.php?rol_sesion=<?php echo $rol_sesion; ?>" class="btn btn-success mb-3">REPORTE EXCEL</a>
